...
var dbhost = Environment.GetEnvironmentVariable("DB_HOST") ?? "DESKTOP\\SQLEXPRESS"; //DESKTOP\\SQLEXPRESS
...
builder.Services.AddHttpClient<ISpotifyGetAlbumTracks,SpotifyGetAlbumTracks>(c =>
{
    c.BaseAddress = new Uri("https://api.spotify.com/v1/");
    c.DefaultRequestHeaders.Add("Accept", "application/.json");
});
